...
(function () {
	...
	function placeWrapper() {
		...
		wStyle.setProperty('flex', '0 0 auto', 'important');
		wStyle.setProperty('min-width', '250px', 'important');
		wStyle.setProperty('max-width', '350px', 'important');
		wStyle.setProperty('width', '300px', 'important');
